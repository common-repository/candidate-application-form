                 ...
                 if($param[1] == 1){
                  ...
                  ?>
                      ...
                      if(strcasecmp($param[0], FIELD_TYPE10) == 0){    /*EditAble PDF */
						...
						?>
						<div id="<?php echo $title_for_field_id_form;?>" class="PDF_ON_FORM" style="min-height:120px;">
							<div><p style="font-size:12px;color:green;"><?php echo urldecode($fld->explanation_text);?></p></div>
							<div>
								<div class="custom_design" style="float: left;margin-right:0px;margin-top:5px;"><a href="<?php echo bloginfo('url').'/wp-content/plugins/'.$custom_plugin_dir_path_form.'downloadpdffile.php?fileUrl='.$upload_dir."wp-content/uploads/".$custom_plugin_name_form."&fileName=".$final_string_new;?>" download="<?php echo bloginfo('url').'/wp-content/plugins/'.$custom_plugin_dir_path_form.'downloadpdffile.php?fileUrl='.$upload_dir."wp-content/uploads/".$custom_plugin_name_form."&fileName=".$final_string_new;?>"><img src="<?php echo bloginfo('url').'/wp-content/plugins/'.$custom_plugin_dir_path_form.'/images/download_img_resize.jpeg'?>" width="160px" height="80px"><!--<input type="button" value="Download PDF">--></a></div>
								<!--<div class="PDF_BLOCK_ON_FORM" style="float: left;width:300px;padding-left:5px">-->
                                <div class="PDF_BLOCK_ON_FORM" style="float:left;width:190px;padding-left:4px">
					                  <div id="CUSTOM_PDF_BLOCK_ON_FORM" style="font-size:10px;">  
					                         <div class="uploader_class" style="float:left;height:45px;padding:5px;">
					                         <div class="container_class"  style="margin:0px;display:inline-block;">
					                          ...
					                          <a class ="multiple_selectt" title = "Select images" alt = "Select images" tabindex="5" href="javascript:;"><!--<img src="http://localhost/wordpress_original/wp-content/plugins/candidate-application-form/images/imgo1.jpeg" width="120px">--><img src="<?php echo bloginfo('url').'/wp-content/plugins/'.$custom_plugin_dir_path_form.'/images/upload_img_resize.jpeg'?>" width="160px"></a>
					                          <a style="display:none;" class ="multiple_upldprev" title = "Upload &amp; Preview" alt = "Upload &amp; Preview" tabindex="6" href="javascript:;">UPLOAD PDF</a>
					                        </div>
					                     ...
					                     <div style="font-size: 12px;clear:both;padding-left:10px;" class="no_file_chosen">No file chosen (<span style="color:red">PDF Only</span>)</div>
                     ...
                     <input type="hidden" id="<?php echo $title_for_field_id.'_explntion_text_popup'; ?>" name="pdf_explntion_text_popup" class="pdf_explanation_text_for_popup" value="<?php echo $fld->explanation_text;?>">                     
                ...
                <?php }
                 ...
                 <?php }
					if(strcasecmp($param[0], FIELD_TYPE7) == 0){    /*email input */ ?>    
						<div>
							<input type="text" name="<?php echo $title; ?>" class="inputclass" />
						</div>
						<div class="clear h20"></div>
						<div>
							<label class="wp_labeltxt ">Confirm <?php echo $title.$compulsory; ?>: </label> 
						</div>
						<div>
							<input type="text" name="Confirm[<?php echo $title; ?>]" class="inputclass" />
							<?php /* Notification check */
							if($param[2] == 1) { ?>
								<input type="hidden" name="notification_emails[]" value="<?php echo $title; ?>" />
							<?php } ?>
						</div>
				<?php } ?>
					<div class="clear h20"></div>
...
<script type="text/javascript">
        jQuery(document).ready(function(){
     	   ...
     	   jQuery(".openDialogForPDF").click( function() {
     	     ...
     	     jQuery("#dialogCrinch").append("<form id='form_dialog_pdf' method='post' enctype='multipart/form-data'><table class='wpaf_dialog_table'><tr><td><div><p style='font-size:12px;color:green;'>"+decodeURI(pdf_text_message)+"</p></div><div id='main_popup_button_div'><div style='float:left;padding-top:3px;margin-left:15px;'><a id='download_pdf_link' style='font-size:12px;color:red;' onclick = 'show_dialog_pdf_input_field();' href='"+custom_pdf_file_path+"' download='"+custom_pdf_file_name+"'><img src='<?php echo bloginfo('url').'/wp-content/plugins/'.$custom_plugin_dir_path_form;?>/images/download_img_resize.jpeg' width='160px' height='36px'></a></div><div style='float:left;padding-top:0px;margin-left:0px;cursor:pointer;'><div class='fileUploadd' style='float:left;margin:5px;cursor:pointer;'><span style='height:36px;width:160px;cursor:pointer;'><img style='cursor:pointer;' width='160px' height='36px' src='<?php echo bloginfo('url').'/wp-content/plugins/'.$custom_plugin_dir_path_form;?>/images/upload_img_resize.jpeg'></span><input id='dialog_fileupload' type='file' class='upload' style='height:38px;cursor:pointer;' multiple/></div><div class='spinner' style='float:left;font-size:14px;color:green;display:none;'>Uploading....</div></div><div id='showPDFfileOnly' style='font-size:10px;margin-left:185px;float:left;color:black'>No file chosen (<span style='color:red'>PDF Only</span>)</div></div><div id='showPDFfileUploaded' style='font-size:10px;margin-left:185px;float:left;font-size:12px;'></div><input type='hidden' name='new_pdf_file_name' id='new_pdf_file_name' value='"+custom_pdf_file_new_name+"'></td></tr></table><input type='hidden' id='PDFUPLOADEDORNOT' value='"+mystringg+"_uploadornot'><input type='hidden' id='PDFUPLOADEDORNOT_NEW' value='"+custom_pdf_file_path_new+"'><input type='hidden' id='PDFUPLOADEDORNOT_PROGRESS' value='"+mystring+"'><input type='hidden' id='Chambeli' value='"+current_file_path_change_to_new_id+"'></form>");
     	   });
...
?>
    ...
    <li class='available_fields'><label><?php echo $compulsory." ".$param[0].":".$new_field->title; ?></label><input name='av_field[]' class='temp_cls1' type='hidden'  value='<?php echo $param[0].":".$param[1].":".$param[2]; ?>' /><input name='av_title[]' class='temp_cls2' type='hidden' value='<?php echo $new_field->title; ?>'><input name='av_options[]' class='temp_cls3' type='hidden' value='<?php echo $final_string_new; ?>'><input name='av_explanation_text[]' class='temp_cls4' type='hidden' value='<?php echo $explanation_text; ?>'><input name='av_explanation_text_location[]' class='temp_cls5' type='hidden' value='<?php echo $explanation_text_location; ?>'></li>
 <?php
   }
 }  
...
?>
   ...
   <li class='available_fields ui-draggable'><label><?php echo $compulsory." ".$param[0].":".$af_field->title; ?></label><input name='af_field[]' class='temp_cls1' type='hidden'  value='<?php echo $param[0].":".$param[1].":".$param[2]; ?>' /><input name='af_title[]' class='temp_cls2' type='hidden' value='<?php echo $af_field->title; ?>'><input name='af_options[]' class='temp_cls3' type='hidden' value='<?php echo $final_string; ?>'><input name='af_explanation_text[]' class='temp_cls4' type='hidden' value='<?php echo $explanation_text; ?>'><input name='af_explanation_text_location[]' class='temp_cls5' type='hidden' value='<?php echo $explanation_text_location; ?>'></li>
<?php }
  }
?>   
</ul> 
...
//crinch, important break ponit
                       ...
                       foreach($af_fields as $key => $value){
                         ...
                         //CRINCH - VERSION2
                         $form_fields[$j]['explanation_text'] = $af_explanation_text[$key];
                         $form_fields[$j]['explanation_text_location'] = $af_explanation_text_location[$key];
                         $j++;
                       }
                  ...
                  if(isset($_POST['av_field'])){
                       ...
                       foreach($av_fields as $key => $value){
                         ...
                         //CRINCH - VERSION2
                         $available_fields[$j]['explanation_text'] = $av_explanation_text[$key];
                         $available_fields[$j]['explanation_text_location'] = $av_explanation_text_location[$key];                                                   
                         $j++;
                       }
        ...
        foreach($af_fields as $fld ){ 
            ...
            if(isset($param[0])){
				...
				if (strpos($fld->title,'@@') !== false) {
                   ...
                   /* if(($param[1] == 1) && ($param[0] == 'EditablePDF') && isset($form_vars['file_upload_path_form']) ){
                    
                    	 
                    	foreach($form_vars['file_upload_path_form'] as $file_key => $file_value){
                    		 
                    		if($title == $file_key){
                    			if(empty($file_value)){
echo 'oooooppp';
                    				$message['file_response']["file_upload_path_form[$file_key]"] = REQUIRED_ERROR_MSG;
                    			}
                    		}
                    	}
