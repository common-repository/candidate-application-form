...
//
   jQuery("#add_new_button").click( function() {
      ...
      //01april - CRINCH done
      jQuery("#dialog").append("<form id='form_dialog' method='post' enctype='multipart/form-data'><table class='wpaf_dialog_table'><tr><td width='22px'><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.FIELD_TYPE_TOOLTIP+"\");'>?</span></td><td width='110px'><span class='dialog_flds'>Field Type:</span></td><td><select onchange='notification_select(this); DeleteItemOnDropDownSelection(); return false;' id='new_field' name='new_field' style='width:180px;'><option value='Text'>Text</option><option value='Upload_CV'>Upload - CV</option><option value='Upload_Other'>Upload - Other</option><option value='LongText'>Long Text</option><option value='Numeric'>Numeric</option><option value='Email'>Email</option><option value='Dropdown'>Dropdown</option><option value='Checkbox'>Checkbox</option><option value='EditablePDF'>Editable PDF</option></select></td></tr><tr><td><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.REQUIRED_TOOLTIP+"\");'>?</span></td><td><span class='dialog_flds'>Required:</span></td><td><input id='required_field' type='checkbox' name='required_field' value='1'></td></tr><tr><td><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.TITLE_OF_FIELD_TOOLTIP+"\");'>?</span></td><td><span class='dialog_flds'>Title of field:</span></td><td><input type='text' name='field_title' id='field_title' /></td></tr><tr id='notification_tr' style='display:none;'><td><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.NOTIFICATION_EMAIL_TOOLTIP+"\");'>?</span></td><td colspan='2'><span class='dialog_flds'>Send candidate notification email:</span>&nbsp;<input id='notification_field' type='checkbox' name='notification_field' value='1'></td></tr><tr id='asifarif-0' class='checkme'><td colspan='3'></td></tr><tr "+showHideAddOptionLink+" id='linkToCreateDynamicOption'><td align='center' colspan='3'><button type='button' id='asif_arif' class='asif_arif' onclick = 'event_add_audience_custom(); return false;'><span class='ui-button-text trigger'>Add OPtion</span></button></td></tr><tr "+showHideUploadPDFField+" id='showHideUploadPDFFieldID'><td><span class='wpaf_tooltip trigger' onmouseover = 'OpenDiv(\""+afTooltip.TITLE_OF_FIELD_TOOLTIP_PDF+"\");'>?</span></td><td><span class='dialog_flds'>PDF File:</span></td><td align='left'><input name='file' id='fileupload' type='file' size='15' multiple/><div id='showPDFfileOnly'style='color:red;font-size:10px;'>Only PDF file!</div><div ='response'></div></td></tr><tr "+showHideUploadPDFFieldExplanation+" id='showHideUploadPDFFieldExplanation'><td><span class='wpaf_tooltip trigger' onmouseover = 'OpenDiv(\""+afTooltip.EXPLANATION_OF_FIELD_TOOLTIP_PDF+"\");'>?</span></td><td><span class='dialog_flds'>Explanation Text:</span></td><td align='left'><textarea rows='4' cols='18' id='pdf_file_explanation' name='pdf_file_explanation'>"+decodeURI(pdf_text_message_default)+"</textarea></td></tr><tr "+showHideUploadPDFFieldExplanationLoaction+" id='showHideUploadPDFFieldExplanationLoaction'><td><span class='wpaf_tooltip trigger' onmouseover = 'OpenDiv(\""+afTooltip.EXPLANATION_OF_FIELD_TOOLTIP_PDF+"\");'>?</span></td><td><span class='dialog_flds'>Text Location:</span></td><td align='left'>On Form<input type='radio' id='pdf_file_location' name='pdf_file_location' value='onform'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;On PopUp<input type='radio' id='pdf_file_location' name='pdf_file_location' value='onpopup' checked></td></tr></table></form>");
      });
  ...
  //new field options radio button value
      ...
      //jQuery("<li class='available_fields'><label>"+compulsory+" "+new_field+":"+field_title+" </label><input name='av_field[]' class='temp_cls1' type='hidden'  value='"+new_field+":"+required_field+"' /><input name='av_title[]' class='temp_cls2' type='hidden' value='"+field_title+"'></li>").insertAfter("#mCSB_1 .mCSB_container ul li:last-child");
        if(new_field=='Dropdown' || new_field=='Checkbox'){
        	...
        	jQuery("<li class='available_fields'><label>"+compulsory+" "+new_field+":"+field_title+" </label><input name='av_field[]' class='temp_cls1' type='hidden'  value='"+new_field+":"+required_field+"' /><input name='av_title[]' class='temp_cls2' type='hidden' value='"+field_title+"'><input name='av_options[]' class='temp_cls3' type='hidden' value='"+final_string+"'><input name='af_explanation_text[]' class='temp_cls4' type='hidden' value='"+pdf_explanation_text+"'><input name='af_explanation_text_location[]' class='temp_cls5' type='hidden' value='"+pdf_explanation_text_location+"'></li>").insertAfter("#mCSB_1 .mCSB_container ul li:last-child");
        }
  ...
  jQuery("#edit_dialog").on( "dialogclose", function( event, ui ) {
     ...
     if(event.cancelable){
  	 ...
  	 if(new_field_type_edit=='EditablePDF'){
  		var already_selected_file_path = jQuery('#alreadySelectedPdf').val();
  		//CRINCH - VERSION2
		 pdf_explanation_text_edit_temp = jQuery('#pdf_file_explanation').val();
		 pdf_explanation_text_edit = escape(pdf_explanation_text_edit_temp);
		 
		 pdf_explanation_text_location_edit = jQuery('#pdf_file_location:checked').val();  		
  		////////////////////////////////
		 event.preventDefault;
...
//START FROM HERE.....VERSINO 2
		...
		notification_var = "<tr id='notification_tr' style='"+notification_var_style+"'><td><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.NOTIFICATION_EMAIL_TOOLTIP+"\");'>?</span></td><td colspan='2'><span class='dialog_flds'>Send candidate notification email:</span>&nbsp;<input id='notification_field' type='checkbox' name='notification_field' value='1' "+notification_field_chk+"></td></tr>";
         ...
         jQuery("#edit_dialog").append("<form id='form_dialog'><table class='wpaf_dialog_table'><tr><td width='22px'><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.FIELD_TYPE_TOOLTIP+"\");'>?</span></td><td width='110px'><span class='dialog_flds'>Field Type:</span></td><td><select onchange='notification_select(this); DeleteItemOnDropDownSelection(); return false;' id='new_field' name='new_field' style='width:180px;'>"+option_str+"</select></td></tr><tr><td><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.REQUIRED_TOOLTIP+"\");'>?</span></td><td><span class='dialog_flds'>Required:</span></td><td><input id='required_field' type='checkbox' name='required_field' value='1' "+required+"></td></tr><tr><td><span class='wpaf_tooltip trigger'  onmouseover = 'OpenDiv(\""+afTooltip.TITLE_OF_FIELD_TOOLTIP+"\");'>?</span></td><td><span class='dialog_flds'>Title of field:</span></td><td><input type='text' name='field_title' id='field_title' value='"+av_title+"' /></td></tr>"+notification_var+"<tr id='asifarif-0' class='checkme'><td colspan='3'></td></tr>"+dynamicOptionsTrs+"<tr "+showHideAddOptionLink+" id='linkToCreateDynamicOption'><td align='center' colspan='3'><button type='button' id='asif_arif' class='asif_arif' onclick = 'event_add_audience_custom(); return false;'><span class='ui-button-text trigger'>Add OPtion</span></button></td></tr></table></form>");
